...
export const SEED_TIMELINE: TimelineEvent[] = [
  ...
  { id: "d17-2", group: "all", day: "2026-06-17", city: "Nueva York", phase: "ny-operations", title: "Llegada + casa de los primos", description: "Transporte a la casa de los primos (alojamiento gratis) y MetroCard de 7 días para el metro.", start: "2026-06-17T17:30:00-04:00", end: "2026-06-17T19:30:00-04:00", locationId: "ny-hotel", lng: loc("ny-hotel").lng, lat: loc("ny-hotel").lat, notes: "MetroCard 7 días ilimitado: $34.", icon: "Building2" },

  // ── 18 jun · Fan Fest del partido de Colombia (NY) ──────────
  { id: "d18-1", group: "all", day: "2026-06-18", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Brunch + The High Line", description: "Sugerencia: brunch en Chelsea y caminar el parque elevado High Line.", start: "2026-06-18T10:30:00-04:00", end: "2026-06-18T12:30:00-04:00", lng: -74.0048, lat: 40.748, icon: "Coffee" },
  { id: "d18-2", group: "all", day: "2026-06-18", city: "Nueva York", phase: "ny-operations", title: "Fan Fest del partido de Colombia (NY)", description: "Zona del fan festival del partido de la Selección Colombia. Entrada hasta $30.", start: "2026-06-18T13:00:00-04:00", end: "2026-06-18T20:00:00-04:00", locationId: "ny-fanfest", lng: loc("ny-fanfest").lng, lat: loc("ny-fanfest").lat, notes: "Presupuesto discrecional ~$50. ¡Vamos Colombia! 🇨🇴", icon: "Trophy" },

  // ── 19 jun · Día libre NY con los primos (sugerencias) ──────
  ...
  { id: "d20-3", group: "all", day: "2026-06-20", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Cena de despedida con los primos", description: "Sugerencia: última cena en NY y preparar maletas (vuelos muy temprano).", start: "2026-06-20T19:00:00-04:00", end: "2026-06-20T21:00:00-04:00", lng: -73.9973, lat: 40.7191, icon: "Utensils" },
