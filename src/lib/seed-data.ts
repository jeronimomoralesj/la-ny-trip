...
export const SEED_TIMELINE: TimelineEvent[] = [
  // ── 8 jun · Salida — Grupo Bogotá (Juan, Jeronimo) ──────────
  ...
  { id: "t-a2", group: "bogota", day: "2026-06-08", city: "Panamá", phase: "traveling-to-la", title: "Escala en Panamá + vuelo a LAX", description: "Conexión en Tocumen y vuelo final a Los Ángeles. Llegada 11:40 pm.", start: "2026-06-08T18:40:00-05:00", end: "2026-06-08T23:40:00-07:00", locationId: "pty", lng: loc("pty").lng, lat: loc("pty").lat, icon: "Plane" },
  // ── 8 jun · Salida — Grupo Boston (Mateo, Valeria) ──────────
  ...
  // ── 9 jun · Encuentro + Partido (todos) ─────────────────────
  { id: "d9-1", group: "all", day: "2026-06-09", city: "Los Ángeles", phase: "la-operations", title: "Encuentro + carro de alquiler", description: "Reunión del grupo completo, recoger el carro y a la base en Downtown.", start: "2026-06-09T09:00:00-07:00", end: "2026-06-09T11:00:00-07:00", locationId: "lax", lng: loc("lax").lng, lat: loc("lax").lat, icon: "Car" },
  { id: "d9-2", group: "all", day: "2026-06-09", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Almuerzo en Grand Central Market", description: "Sugerencia: clásico mercado gastronómico del Downtown antes del partido.", start: "2026-06-09T12:30:00-07:00", end: "2026-06-09T14:00:00-07:00", lng: -118.2489, lat: 34.0506, icon: "Utensils" },
  { id: "d9-3", group: "all", day: "2026-06-09", city: "Los Ángeles", phase: "la-operations", title: "Partido del Mundial @ SoFi", description: "Partido de fase de grupos. Todos con la camiseta.", start: "2026-06-09T16:00:00-07:00", end: "2026-06-09T19:00:00-07:00", locationId: "sofi", lng: loc("sofi").lng, lat: loc("sofi").lat, notes: "Entradas en el Baúl de Documentos. Llegar 2h antes.", icon: "Trophy" },

  // ── 10 jun · Día libre LA (sugerencias detalladas) ──────────
  { id: "d10-1", group: "all", day: "2026-06-10", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Desayuno + Venice Beach", description: "Sugerencia: desayuno frente al mar y paseo por el boardwalk y Muscle Beach.", start: "2026-06-10T09:30:00-07:00", end: "2026-06-10T11:30:00-07:00", lng: -118.4695, lat: 33.985, icon: "Waves" },
  { id: "d10-2", group: "all", day: "2026-06-10", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Canales de Venice + almuerzo", description: "Sugerencia: caminar los Venice Canals y almorzar en Abbot Kinney.", start: "2026-06-10T11:30:00-07:00", end: "2026-06-10T13:30:00-07:00", lng: -118.4695, lat: 33.9853, icon: "Utensils" },
  { id: "d10-3", group: "all", day: "2026-06-10", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Muelle de Santa Mónica", description: "Sugerencia: rueda de la fortuna, juegos y caminar hasta el muelle.", start: "2026-06-10T14:00:00-07:00", end: "2026-06-10T16:30:00-07:00", locationId: "santa-monica", lng: loc("santa-monica").lng, lat: loc("santa-monica").lat, icon: "Sunset" },
  { id: "d10-4", group: "all", day: "2026-06-10", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Hollywood Blvd + Paseo de la Fama", description: "Sugerencia: Walk of Fame, TCL Chinese Theatre y Dolby Theatre.", start: "2026-06-10T17:00:00-07:00", end: "2026-06-10T18:30:00-07:00", lng: -118.3287, lat: 34.1016, icon: "Camera" },
  { id: "d10-5", group: "all", day: "2026-06-10", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Atardecer en Griffith Observatory", description: "Sugerencia: el mejor skyline de LA + letrero de Hollywood al atardecer.", start: "2026-06-10T19:00:00-07:00", end: "2026-06-10T21:00:00-07:00", lng: -118.3004, lat: 34.1184, icon: "Sunset" },

  // ── 11 jun · PARK HOP: Disneyland → Six Flags ───────────────
  { id: "d11-1", group: "all", day: "2026-06-11", city: "Anaheim", phase: "disneyland-day", title: "Disneyland — apertura (rope drop)", description: "Empezamos con la apertura para aprovechar las filas bajas. Mira la pestaña Ruta en Parques.", start: "2026-06-11T07:30:00-07:00", end: "2026-06-11T13:30:00-07:00", locationId: "disneyland", lng: loc("disneyland").lng, lat: loc("disneyland").lat, notes: "Punto de encuentro: el Castillo. Genie+/Lightning Lane recomendado.", icon: "Castle" },
  { id: "d11-2", group: "all", day: "2026-06-11", city: "Valencia", phase: "la-operations", title: "Six Flags Magic Mountain (tarde/noche)", description: "Park hopping ⚡ — salimos de Disneyland 1:30 pm (~1h15 de viaje) y maratón de coasters hasta el cierre.", start: "2026-06-11T14:45:00-07:00", end: "2026-06-11T22:00:00-07:00", locationId: "sixflags", lng: loc("sixflags").lng, lat: loc("sixflags").lat, notes: "Ruta sugerida de coasters en la pestaña Ruta.", icon: "Rocket" },

  // ── 12 jun · Día libre LA (sugerencias) ─────────────────────
  { id: "d12-1", group: "all", day: "2026-06-12", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Beverly Hills + Rodeo Drive", description: "Sugerencia: vitrinear en Rodeo Drive y foto en el letrero de Beverly Hills.", start: "2026-06-12T10:00:00-07:00", end: "2026-06-12T12:00:00-07:00", lng: -118.4004, lat: 34.0696, icon: "ShoppingBag" },
  { id: "d12-2", group: "all", day: "2026-06-12", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Almuerzo en The Grove / Farmers Market", description: "Sugerencia: comida variada en el histórico Original Farmers Market.", start: "2026-06-12T12:30:00-07:00", end: "2026-06-12T14:00:00-07:00", lng: -118.358, lat: 34.0719, icon: "Utensils" },
  { id: "d12-3", group: "all", day: "2026-06-12", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "LACMA + Urban Light", description: "Sugerencia: museo de arte y la icónica instalación de faroles.", start: "2026-06-12T14:30:00-07:00", end: "2026-06-12T16:30:00-07:00", lng: -118.3592, lat: 34.0639, icon: "Landmark" },
  { id: "d12-4", group: "all", day: "2026-06-12", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Cena de despedida de LA", description: "Sugerencia: última cena en LA antes de volar al este (Guelaguetza o Grand Central Market).", start: "2026-06-12T19:00:00-07:00", end: "2026-06-12T21:00:00-07:00", lng: -118.2935, lat: 34.0577, icon: "Utensils" },

  // ── 13 jun · Vuelo a Nueva York ─────────────────────────────
  { id: "d13-1", group: "all", day: "2026-06-13", city: "Los Ángeles", phase: "traveling-to-ny", title: "Vuelo LAX → JFK", description: "Salto transcontinental a Nueva York (Delta DL 1845).", start: "2026-06-13T09:00:00-07:00", end: "2026-06-13T17:30:00-04:00", locationId: "lax", lng: loc("lax").lng, lat: loc("lax").lat, icon: "Plane" },
  { id: "d13-2", group: "all", day: "2026-06-13", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Check-in + cena en Midtown", description: "Sugerencia: dejar maletas en el hotel y cena tranquila cerca de Times Square.", start: "2026-06-13T19:00:00-04:00", end: "2026-06-13T21:00:00-04:00", lng: -73.9845, lat: 40.7549, icon: "Utensils" },

  // ── 14 jun · Fan Festival NYC ───────────────────────────────
  { id: "d14-1", group: "all", day: "2026-06-14", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Brunch + The High Line", description: "Sugerencia: brunch en Chelsea y caminar el parque elevado High Line.", start: "2026-06-14T10:00:00-04:00", end: "2026-06-14T12:30:00-04:00", lng: -74.0048, lat: 40.748, icon: "Coffee" },
  { id: "d14-2", group: "all", day: "2026-06-14", city: "Nueva York", phase: "ny-operations", title: "Fan Festival NYC", description: "Fan fest oficial de la FIFA en Liberty State Park + vista del skyline.", start: "2026-06-14T13:00:00-04:00", end: "2026-06-14T20:00:00-04:00", locationId: "ny-fanfest", lng: loc("ny-fanfest").lng, lat: loc("ny-fanfest").lat, icon: "PartyPopper" },

  // ── 15 jun · Día libre NY (sugerencias) ─────────────────────
  { id: "d15-1", group: "all", day: "2026-06-15", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Estatua de la Libertad + Ellis Island", description: "Sugerencia: ferry temprano desde Battery Park (reservar pedestal).", start: "2026-06-15T09:00:00-04:00", end: "2026-06-15T12:30:00-04:00", lng: -74.0445, lat: 40.6892, icon: "Ship" },
  { id: "d15-2", group: "all", day: "2026-06-15", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Memorial y Museo del 9/11", description: "Sugerencia: las piscinas memoriales y One World Observatory.", start: "2026-06-15T14:00:00-04:00", end: "2026-06-15T16:30:00-04:00", lng: -74.0134, lat: 40.7115, icon: "Landmark" },
  { id: "d15-3", group: "all", day: "2026-06-15", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Puente de Brooklyn al atardecer", description: "Sugerencia: cruzar a pie hacia DUMBO para el atardecer y fotos del skyline.", start: "2026-06-15T18:00:00-04:00", end: "2026-06-15T20:00:00-04:00", lng: -73.9969, lat: 40.7061, icon: "Sunset" },

  // ── 16 jun · Día en Manhattan ───────────────────────────────
  { id: "d16-1", group: "all", day: "2026-06-16", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Central Park (bici o caminata)", description: "Sugerencia: Bethesda Terrace, The Mall y Strawberry Fields.", start: "2026-06-16T10:00:00-04:00", end: "2026-06-16T12:30:00-04:00", lng: -73.9654, lat: 40.7829, icon: "Bike" },
  { id: "d16-2", group: "all", day: "2026-06-16", city: "Nueva York", phase: "ny-operations", suggested: true, title: "MoMA o The MET", description: "Sugerencia: una tarde de museo de clase mundial.", start: "2026-06-16T13:30:00-04:00", end: "2026-06-16T15:30:00-04:00", lng: -73.9776, lat: 40.7614, icon: "Landmark" },
  { id: "d16-3", group: "all", day: "2026-06-16", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Top of the Rock", description: "Sugerencia: mirador con la mejor vista del Empire State.", start: "2026-06-16T16:30:00-04:00", end: "2026-06-16T18:00:00-04:00", lng: -73.9787, lat: 40.7593, icon: "Building2" },
  { id: "d16-4", group: "all", day: "2026-06-16", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Times Square + porción en Joe's Pizza", description: "Sugerencia: el neón de Times Square y la porción clásica de NY.", start: "2026-06-16T18:30:00-04:00", end: "2026-06-16T21:00:00-04:00", locationId: "times-square", lng: loc("times-square").lng, lat: loc("times-square").lat, icon: "Utensils" },

  // ── 17 jun · Día libre NY (sugerencias) ─────────────────────
  { id: "d17-1", group: "all", day: "2026-06-17", city: "Nueva York", phase: "ny-operations", suggested: true, title: "The MET — Upper East Side", description: "Sugerencia: mañana en el museo más grande de EE.UU.", start: "2026-06-17T10:00:00-04:00", end: "2026-06-17T13:00:00-04:00", lng: -73.9632, lat: 40.7794, icon: "Landmark" },
  { id: "d17-2", group: "all", day: "2026-06-17", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Almuerzo + paseo por el parque", description: "Sugerencia: almuerzo en el Upper East Side y norte de Central Park.", start: "2026-06-17T13:00:00-04:00", end: "2026-06-17T15:30:00-04:00", lng: -73.9654, lat: 40.7829, icon: "Utensils" },
  { id: "d17-3", group: "all", day: "2026-06-17", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Cena en Little Italy / Chinatown", description: "Sugerencia: pasta en Little Italy o dumplings en Chinatown.", start: "2026-06-17T18:30:00-04:00", end: "2026-06-17T20:30:00-04:00", lng: -73.9973, lat: 40.7191, icon: "Utensils" },

  // ── 18 jun · Día libre NY — Brooklyn (sugerencias) ──────────
  { id: "d18-1", group: "all", day: "2026-06-18", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Williamsburg, Brooklyn", description: "Sugerencia: tiendas, murales y café de especialidad.", start: "2026-06-18T10:30:00-04:00", end: "2026-06-18T13:00:00-04:00", lng: -73.9571, lat: 40.7081, icon: "ShoppingBag" },
  { id: "d18-2", group: "all", day: "2026-06-18", city: "Nueva York", phase: "ny-operations", suggested: true, title: "Smorgasburg (comida callejera)", description: "Sugerencia: el mercado de comida al aire libre más famoso de NY (fines de semana).", start: "2026-06-18T13:00:00-04:00", end: "2026-06-18T15:00:00-04:00", lng: -73.9665, lat: 40.7215, icon: "Utensils" },
  { id: "d18-3", group: "all", day: "2026-06-18", city: "Nueva York", phase: "ny-operations", suggested: true, title: "DUMBO + rooftop al atardecer", description: "Sugerencia: foto en Washington St, luego un rooftop bar con vista al puente.", start: "2026-06-18T17:30:00-04:00", end: "2026-06-18T20:00:00-04:00", lng: -73.9903, lat: 40.7033, icon: "Sunset" },

  // ── 19 jun · Mundial @ MetLife ──────────────────────────────
  { id: "d19-1", group: "all", day: "2026-06-19", city: "Nueva York", phase: "ny-operations", title: "Mundial @ MetLife", description: "El partidazo. Último del viaje. ¡A dejar todo en la tribuna!", start: "2026-06-19T15:00:00-04:00", end: "2026-06-19T18:30:00-04:00", locationId: "metlife", lng: loc("metlife").lng, lat: loc("metlife").lat, notes: "Salir con tiempo — transporte a Nueva Jersey se congestiona.", icon: "Trophy" },

  // ── 20 jun · Último día NY + regreso ────────────────────────
  { id: "d20-1", group: "all", day: "2026-06-20", city: "Nueva York", phase: "return-to-colombia", suggested: true, title: "Compras de último minuto — 5th Avenue", description: "Sugerencia: souvenirs y tiendas en la Quinta Avenida antes de los vuelos.", start: "2026-06-20T11:00:00-04:00", end: "2026-06-20T14:00:00-04:00", lng: -73.9772, lat: 40.764, icon: "ShoppingBag" },
  { id: "d20-2", group: "boston", day: "2026-06-20", city: "Nueva York", phase: "return-to-colombia", title: "Vuelo JFK → BOS", description: "Mateo y Valeria regresan a Boston.", start: "2026-06-20T21:00:00-04:00", end: "2026-06-20T22:25:00-04:00", locationId: "jfk", lng: loc("jfk").lng, lat: loc("jfk").lat, icon: "Plane" },
  { id: "d20-3", group: "bogota", day: "2026-06-20", city: "Nueva York", phase: "return-to-colombia", title: "Vuelo nocturno JFK → BOG", description: "Vuelo de regreso de noche para Juan y Jeronimo.", start: "2026-06-20T23:30:00-04:00", end: "2026-06-21T06:30:00-05:00", locationId: "jfk", lng: loc("jfk").lng, lat: loc("jfk").lat, notes: "Aterrizar, dejar maletas y a votar.", icon: "Plane" },

  // ── 21 jun · Aterrizar y votar ──────────────────────────────
  { id: "d21-1", group: "bogota", day: "2026-06-21", city: "Bogotá", phase: "election-day", title: "Aterrizar + VOTAR", description: "Directo del aeropuerto al puesto de votación.", start: "2026-06-21T08:00:00-05:00", end: "2026-06-21T12:00:00-05:00", locationId: "bog", lng: loc("bog").lng, lat: loc("bog").lat, notes: "Llevar la cédula. Verificar el puesto la noche anterior.", icon: "Vote" },
];
