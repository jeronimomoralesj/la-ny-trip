...
export const SEED_TIMELINE: TimelineEvent[] = [
  ...
  // ── 11 jun · PARK HOP: Disneyland Park → Disney California Adventure ──
  { id: "d11-1", group: "all", day: "2026-06-11", city: "Anaheim", phase: "disneyland-day", title: "Disneyland Park — apertura (rope drop)", description: "Empezamos con la apertura para aprovechar las filas bajas. Mira la pestaña Ruta en Parques.", start: "2026-06-11T07:30:00-07:00", end: "2026-06-11T13:30:00-07:00", locationId: "disneyland", lng: loc("disneyland").lng, lat: loc("disneyland").lat, notes: "Punto de encuentro: el Castillo. Lightning Lane recomendado para Rise of the Resistance.", icon: "Castle" },
  { id: "d11-2", group: "all", day: "2026-06-11", city: "Anaheim", phase: "disneyland-day", title: "Park hop → Disney California Adventure", description: "Cruzamos a DCA en la tarde (los parques están uno frente al otro): Radiator Springs Racers, Avengers Campus, Pixar Pier y Cars Land de noche.", start: "2026-06-11T14:00:00-07:00", end: "2026-06-11T22:00:00-07:00", lng: -117.9209, lat: 33.8064, notes: "Necesita boleto Park Hopper. World of Color al cierre.", icon: "Sparkles" },

  // ── 12 jun · Six Flags Magic Mountain (día propio) ──────────
  { id: "d12-1", group: "all", day: "2026-06-12", city: "Valencia", phase: "la-operations", title: "Six Flags Magic Mountain", description: "Día completo de montañas rusas: X2, Twisted Colossus, Tatsu, Full Throttle y más. Mira la Ruta sugerida en Parques.", start: "2026-06-12T10:00:00-07:00", end: "2026-06-12T21:00:00-07:00", locationId: "sixflags", lng: loc("sixflags").lng, lat: loc("sixflags").lat, notes: "Llegar a la apertura (10:30) para las filas bajas. ~1h15 desde Downtown LA.", icon: "Rocket" },
  { id: "d12-2", group: "all", day: "2026-06-12", city: "Los Ángeles", phase: "la-operations", suggested: true, title: "Cena de despedida de LA", description: "Sugerencia: al volver de Six Flags, última cena en LA (Guelaguetza o Grand Central Market).", start: "2026-06-12T21:30:00-07:00", end: "2026-06-12T23:00:00-07:00", lng: -118.2935, lat: 34.0577, icon: "Utensils" },
